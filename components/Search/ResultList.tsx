...
const Entry = ({ result }: { result: SearchResult }) => {
  return (
    <div className="mb-5 border border-[#EEEEEE] hover:cursor-pointer hover:shadow-md md:flex">
      <div className="flex items-center gap-4 p-5 md:w-3/6">
        <div>
          <svg
            width="35"
            height="36"
        ...
        <div>
          ...
          <div className="text-sm md:hidden">{result?.groblje?.name}</div>
        </div>
      </div>

      <div className="mb-3 hidden px-5 text-secondary-dark md:mb-0 md:block md:w-3/6 md:bg-gray-200 md:p-5">
