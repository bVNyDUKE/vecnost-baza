...
const NavBar = () => (
  <nav className="sticky mb-10 top-0 w-full flex justify-center items-center after:block after:absolute after:-bottom-[2px] after:w-[70px] after:h-[5px] after:bg-[#c9c9c9]">
